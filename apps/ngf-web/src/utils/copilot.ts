...
import type { Choice, ChoiceId, DialogueNode, NarrativeGraph, NodeId, Outcome } from '@kibbel/ngf-core';
import type { ValidationIssue, ValidationReport } from '@kibbel/ngf-validate';
